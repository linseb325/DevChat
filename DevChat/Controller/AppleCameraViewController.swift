...
class AppleCameraViewController: UIViewController, AVCaptureFileOutputRecordingDelegate {
    
    
    var delegate: AppleCameraVCDelegate?
	...
	weak var _previewView: ApplePreviewView!
